...
dotnet restore src/MarketDataCollector.Wpf/MarketDataCollector.Wpf.csproj
...
dotnet publish src/MarketDataCollector.Wpf/MarketDataCollector.Wpf.csproj -c Release -r win-x64 --self-contained
```
...
Configuration is stored in: `%APPDATA%\MarketDataCollector\appsettings.json`
...
Copyright 2024-2026 MarketDataCollector Team. See [LICENSE](../../LICENSE) for details.
