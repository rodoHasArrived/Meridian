...
public partial class BackfillPage : Page
{
    ...
    {
        _viewModel.UpdateProviderPrioritySummary(
            GetProviderName(PrimaryProviderCombo),
            GetProviderName(SecondaryProviderCombo),
            GetProviderName(TertiaryProviderCombo));
    }
