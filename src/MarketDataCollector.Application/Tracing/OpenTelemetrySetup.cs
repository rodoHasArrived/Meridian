...
{
    /// <summary>
    /// The activity source for MarketDataCollector tracing.
    /// </summary>
    public static readonly ActivitySource ActivitySource = new("MarketDataCollector", "1.0.0");
...
{
    public string ServiceName { get; init; } = "MarketDataCollector";
