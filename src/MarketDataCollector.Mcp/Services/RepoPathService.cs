...
{
    private const string SolutionFileName = "MarketDataCollector.sln";
    ...
    public string TemplatesPath => Path.Combine(Root, "src", "MarketDataCollector.Infrastructure", "Adapters", "_Template");
    public string AdaptersPath => Path.Combine(Root, "src", "MarketDataCollector.Infrastructure", "Adapters");
