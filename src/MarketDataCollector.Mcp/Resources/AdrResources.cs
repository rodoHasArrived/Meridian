...
public sealed class AdrResources(RepoPathService repo)
{
    ...
    [Description("Index of all 14 Architecture Decision Records in the MarketDataCollector project.")]
    public string GetAdrIndex()
    {
        ...
        sb.AppendLine("# MarketDataCollector — Architecture Decision Records\n");
