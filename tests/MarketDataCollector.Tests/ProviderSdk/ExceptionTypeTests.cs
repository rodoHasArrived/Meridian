...
{
    #region MarketDataCollectorException (base)

    [Fact]
    public void MarketDataCollectorException_MessageOnly_SetsMessage()
    {
    ...
    [Fact]
    public void MarketDataCollectorException_WithInnerException_PropagatesBoth()
    {
        var inner = new InvalidOperationException("inner");
        var ex = new MarketDataCollectorException("outer", inner);
    ...
    [Fact]
    public void MarketDataCollectorException_IsException()
    {
        var ex = new MarketDataCollectorException("test");
    ...
    [Fact]
    public void AllCustomExceptions_InheritFromMarketDataCollectorException()
    {
        typeof(ConfigurationException).Should().BeDerivedFrom<MarketDataCollectorException>();
        typeof(ConnectionException).Should().BeDerivedFrom<MarketDataCollectorException>();
        typeof(DataProviderException).Should().BeDerivedFrom<MarketDataCollectorException>();
        typeof(RateLimitException).Should().BeDerivedFrom<DataProviderException>();
        typeof(StorageException).Should().BeDerivedFrom<MarketDataCollectorException>();
        typeof(ValidationException).Should().BeDerivedFrom<MarketDataCollectorException>();
        typeof(OperationTimeoutException).Should().BeDerivedFrom<MarketDataCollectorException>();
        typeof(SequenceValidationException).Should().BeDerivedFrom<MarketDataCollectorException>();
    }
