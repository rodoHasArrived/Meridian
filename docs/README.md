...
- [High-Impact Improvements Brainstorm](evaluations/high-impact-improvements-brainstorm.md) — Platform-level strategic opportunities (effort-agnostic)
- [High-Value Low-Cost Improvements Brainstorm](evaluations/high-value-low-cost-improvements-brainstorm.md) — Practical improvement ideas prioritized by value and cost
...
*Documentation maintained by core team. Last update: 2026-03-11*
